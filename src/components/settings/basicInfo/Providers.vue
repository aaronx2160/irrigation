    ...
    <div class="wrapper">
                    ...
                    <el-table-column label="操作" prop="" align="center">
                        <template>
                            <el-button
                                size="mini"
                                type="warning"
                                @click="editProviderVisible = true"
                                >修改</el-button
                            >
                            <el-button
                                size="mini"
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="addProviderVisible = false"
                    >确 定</el-button
                >
            </span>
        </el-dialog>
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="editProviderVisible = false"
                    >取 消</el-button
                >
                <el-button type="primary" @click="editProviderVisible = false"
                    >确 定</el-button
                >
            </span>
        </el-dialog>
