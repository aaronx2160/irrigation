<template>
    <div class="wrapper">
        ...
        <el-dialog title="新增" :visible.sync="addMaterialVisible" width="30%">
        ...
        <el-dialog title="修改" :visible.sync="editMaterialVisible" width="30%">
            <el-form ref="form" label-width="auto">
                <el-form-item label="泵管材质:">
                    <el-input></el-input>
                </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="editMaterialVisible = false"
                    >取 消</el-button
                >
                <el-button type="primary" @click="editMaterialVisible = false"
                    >确 定</el-button
                >
            </span>
        </el-dialog>
