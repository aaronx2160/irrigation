<template>
    <div class="wrapper">
        <div slot="header" class="card-header">
            <div class="header-btn">
                <el-button
                    ...
                    size="small"
                    @click="addWaterResourceVisible = true"
                    >新增</el-button
                >
                <el-button
                    type="danger"
            ...
            <el-button type="info" icon="el-icon-search" size="small"
                >搜索</el-button
            >
        </div>
        <div>
        ...
        <el-dialog
            title="添加水资源设置"
            :visible.sync="addWaterResourceVisible"
            width="30%"
        >
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="addRegionDialogVisible = false"
                    >取 消</el-button
                >
                <el-button
                    type="primary"
                    @click="addRegionDialogVisible = false"
                    >确 定</el-button
                >
            </span>
        </el-dialog>
