  ...
  <div class="wrapper">
    ...
    <div>
      <template>
        <el-table :data="regionData" style="width: 100%;" border stripe>
          ...
          <el-table-column label="起始时间" prop="regionName" align="center">
          </el-table-column>
          <el-table-column label="结束时间" prop="regionName" align="center">
          </el-table-column>
          <el-table-column
            label="最长不不在线(天)"
            prop="regionName"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addExceptParamsVisible = false">取 消</el-button>
        <el-button type="primary" @click="addExceptParamsVisible = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
