  ...
  <div class="wrapper">
    ...
    <div>
      <template>
        <el-table :data="regionData" style="width: 100%;" border stripe>
          ...
          <el-table-column label="下行百分比" prop="regionCode" align="center">
          </el-table-column>
          <el-table-column label="上行百分比" prop="regionName" align="center">
          </el-table-column>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addPowerSettingVisible = false">取 消</el-button>
        <el-button type="primary" @click="addPowerSettingVisible = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="editThreePowerVoltageVisible = false"
          >取 消</el-button
        >
        <el-button type="primary" @click="editThreePowerVoltageVisible = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
