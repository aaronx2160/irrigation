                ...
                <v-container>
                    ...
                    <v-row>
                        <v-col cols="9" md="3">
                            <span
                                >是否办理取水许可证:
                                <el-radio
                                    v-model="extendedWellInfo.IsHandleDocument"
                                    :label="1"
                                    >是</el-radio
                                >
                                <el-radio
                        ...
                        <v-col cols="9" md="3">
                            <span
                                ...
                                <el-radio
                                    v-model="
                                        extendedWellInfo.IsIndustryProcedure
                                    "
                                    :label="1"
                                    >是</el-radio
                                >
                    ...
                    <v-row>
                        ...
                        >
                            <v-text-field
                                type="number"
                                v-model="
                                    extendedWellInfo.IndustryProductionCapacity
                                "
                                label="生产规模(万元)"
                                dense
                            ></v-text-field>
                        ...
                        <v-col cols="9" md="3">
                            <span
                                ...
                                <el-radio
                                    v-model="
                                        extendedWellInfo.WaterMeterMeasurement
                                    "
                                    :label="1"
                                    >是</el-radio
                                >
                    ...
                    <v-row>
                        <v-col
                            ...
                            md="3"
                            v-show="
                                extendedWellInfo.WaterMeterMeasurement === 1
                            "
                        >
                            <v-select
                                v-model="
                                    extendedWellInfo.WaterMeterMeasurementType
                                "
                                :items="measureType"
                                label="水量计量设施类型"
                                dense
                    ...
                    <v-row>
                        ...
                        >
                            <span
                                >有无水表防护罩:
                                <el-radio
                                    v-model="extendedWellInfo.MeterGuard"
                                    :label="1"
                                    >有</el-radio
                                >
                                <el-radio
...
export default {
    ...
    mounted() {
        // const { data: res } = await this.$http.get('/api/wellExtendedInfo')
        this.getData()
    ...
    methods: {
        async getData() {
            ...
            //泵管材质 pumpMaterial
            this.pumpMaterial = await this.getAddFormSelectOptions(
                'pumpMaterial'
            )
            //运营商
            this.operator = await this.getAddFormSelectOptions('operator')
            //取水类型
            this.useWaterType = await this.getAddFormSelectOptions(
                'useWaterType'
            )
            //应用状况 applyStatus
            ...
            //灌溉模式irrigationMode
            this.irrigationMode = await this.getAddFormSelectOptions(
                'irrigationMode'
            )
            //水量计量设施类型：
            ...
            //地貌类型landFormType
            this.landFormType = await this.getAddFormSelectOptions(
                'landFormType'
            )
