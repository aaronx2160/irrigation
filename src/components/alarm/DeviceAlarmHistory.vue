<template>
    <div class="wrapper">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>设备告警历史</el-breadcrumb-item>
        </el-breadcrumb>
        <el-card>
            <div slot="header" class="card-header">
                <template>
                    <el-form label-width="auto">
                        <el-form-item label="设备编码:" prop="roleName">
                            <el-input></el-input>
                        </el-form-item>
            ...
            <div>
                <template>
                    <el-table style="width: 100%;" border stripe>
                        ...
                        <el-table-column label="警报时间" align="center">
                        </el-table-column>
                    </el-table>
                </template>
            </div>
        ...
        >
            ...
            <el-image
                src="https://s3.ax1x.com/2021/01/04/sPLhNV.png"
            ></el-image>
