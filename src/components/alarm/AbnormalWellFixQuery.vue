<template>
  <div class="wrapper">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>异常机井处理查询</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <div slot="header" class="card-header">
        <template>
          <el-form label-width="auto">
            <el-form-item label="水卡编号:" prop="roleName">
              <el-input></el-input>
            </el-form-item>
            <el-form-item label="设备编号:" prop="roleName">
              <el-input></el-input>
            </el-form-item>
      ...
      <div>
        <template>
          <el-table style="width: 100%;" border stripe>
            ...
            <el-table-column label="异常情况" align="center"> </el-table-column>
            <el-table-column label="异常机井处理状态" align="center">
            </el-table-column>
          </el-table>
        </template>
      </div>
