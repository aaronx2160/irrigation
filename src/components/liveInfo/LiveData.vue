                ...
                <v-card>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        v-if="
                                            wellDetailDialogData.NetState === 1
                                        "
                                        class="iconfont icon-kaiqi"
                                        style="color: #56bd78;"
                                        >在线</span
                                ...
                                <td>
                                    <span
                                        v-if="
                                            wellDetailDialogData.AlarmState ===
                                            0
                                        "
                                        class="iconfont icon-kaiqi"
                                        style="color: #56bd78;"
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        v-if="
                                            wellDetailDialogData.PumpState === 1
                                        "
                                        class="iconfont icon-kaiqi"
                                        style="color: #56bd78;"
                                        >开启</span
                                ...
                                <td>
                                    <span
                                        v-if="
                                            wellDetailDialogData.DoorState === 0
                                        "
                                        class="iconfont icon-kaiqi"
                                        style="color: #56bd78;"
                                        >关闭</span
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        v-if="
                                            wellDetailDialogData.CardState === 1
                                        "
                                        class="iconfont icon-kaiqi"
                                        style="color: #56bd78;"
                                        >上卡</span
                    ...
                    <v-simple-table v-else class="history-data-tbl" dense>
                        <tr class="thead">
                            <th
                                :colspan="
                                    this.wellDetailDialogNavActive ? 4 : 6
                                "
                            ></th>
                        </tr>
                        <tbody>
                    ...
                    <el-pagination
                        ...
                        @current-change="
                            handleWellDetailDialogHistoryPageChange
                        "
                    >
                    </el-pagination>
                    <v-divider></v-divider>
...
export default {
    ...
    methods: {
        handlePageChange(pageNum) {
            let arrToPagenate = this.filterOn
                ? this.wellListFiltered
                : this.wellList
